<?php 
	...
	if (isset($_GET['sw']) == "relog") { //Si première connexion ou changement de compte
		$lnk = "../../assets/libraries/action?sw=relog"; //Variable de lien en fonction de la condition
	}
	else { //Sinon
		$lnk = "../../assets/libraries/action"; //Variable de lien en fonction de la condition
	} //Fin si
?>
